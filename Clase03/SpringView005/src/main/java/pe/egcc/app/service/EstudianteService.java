...
public class EstudianteService {
	...
	public void validar(EstudianteBean estudianteBean) {
		// Verificando Nombre
		String errorNombre = "";
		if (estudianteBean.getNombre().isEmpty()) {
		...
		// Consolidando mensajes
		String mensajeTotal = mensaje;
		if (!errorNombre.isEmpty()) {
			if (mensajeTotal.isEmpty()) {
				mensajeTotal = errorNombre;
			} else {
				mensajeTotal += " " + errorNombre;
			}
		}
		throw new NotaFueraDeRango(mensajeTotal);
	}
