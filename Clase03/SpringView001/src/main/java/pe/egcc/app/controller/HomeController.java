...
public class HomeController {
  ...
  public ModelAndView home() {
    ...
    bean.setNombre("Gustavo Coronel");
    bean.setNota1(18);
    bean.setNota2(20);
    
    ModelAndView view = new ModelAndView("home","estudianteBean", bean);
    return view;

  }

  @RequestMapping(value = "/doProcesarEstudiante.htm", method = RequestMethod.POST)
  public ModelAndView doProcesarEstudiante(
	@ModelAttribute("estudianteBean") EstudianteBean estudianteBean) {
